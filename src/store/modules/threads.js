...
export default {
    ...
    actions: {
        ...
        fetchThread: ({dispatch}, {id}) => dispatch('fetchItem', {resource: 'threads', id, emoji: 'fetchThread 🔥'}, {root: true}),

        fetchThreads: ({dispatch}, {ids}) => dispatch('fetchItems', {resource: 'threads', ids, emoji: 'fetchThreads 🔥'}, {root: true}),
    },
